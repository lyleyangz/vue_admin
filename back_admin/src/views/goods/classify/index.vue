<template>
    <div>
        ...
        <Modal :width="500" class="modal" class-name="vertical-center-modal" v-model="modal.is" title="添加分类">
            <Row>
                <Col>
                ...
                <Col >
                    ...
                    <span><my-upload :uploadList="uploadList"></my-upload></span>
                </Col>
                <Col>
                    <span class="lb"></span>
    ...
    methods: {
        ...
        save(){
            ...
            if(this.uploadList.length>0){
                ...
                this.params.icon = uploadList.join(",");
            }
            if(this.params.id){
